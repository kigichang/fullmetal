...
import { equationChem, TWO_REACTANT_REACTIONS as TWO_REACTANT, type Reaction } from '../../chem/equations'
...
/** 質量與莫耳：輸入克數或莫耳數，引導或直接算出限量試劑 */
export function MassMoles() {
  ...
  const equation = equationChem(reaction)
